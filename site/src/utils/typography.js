...
const headerFontFamily = [`Coiny`, `Futura PT`, `-apple-system`, `sans-serif`]
...
const _options = {
  ...
  bodyFontFamily: [`Open Sans`, `Roboto`],
  monospaceFontFamily: [`Fira Mono`, `Menlo`, `monospace`],
  systemFontFamily: [`-apple-system`, `Helvetica Neue`, `Arial`, `sans-serif`],
  baseLineHeight: 1.4,
  baseFontSize: `16px`,
